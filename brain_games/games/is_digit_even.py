"""Модуль содержит точку входа в игру 'Is Digit Even?'."""

from brain_games.cli import run_game
from brain_games.scripts.is_digit_even import get_main_data
from brain_games.types import GetMainDataFunc


@run_game
def run_is_digit_even() -> tuple[str, GetMainDataFunc]:
    """Запускает игру 'Is Digit Even?'.
